...
def create_order():
    ...
    amount = data.get('amount', 1200)  # Default: ₹1 in paise
    ...
    try:
        print("🚀 Creating Razorpay order with:", order_data)  # Debug log
        ...
        print("❌ Razorpay order creation failed:", str(e))  # Error log
